            ...
            <div className="container mx-auto px-4 md:px-6 flex items-center justify-between">
                ...
                <div className="flex items-center bg-white rounded-2xl shadow-lg overflow-hidden border border-stone-100">
                    ...
                    <div className="flex flex-col items-center px-5 py-3">
                        <span className="text-[8px] font-bold text-stone-300 uppercase tracking-[0.18em] mb-2">
                            Powered by
                        </span>
                    ...
                    >
                        <div className="flex flex-col p-4 gap-4">
                            ...
                            <Button className="w-full mt-2">
                                <a
                                    href="https://gedae.ggpen.gov.ao/ferramenta-de-visualizacao/otchiva/en"
                                    rel="noopener noreferrer"
                                >
                                    Aceder à Plataforma
                                </a>
